...
3. Bind the snapshot folder to the running Elastic via JSON API as follow: curl -XPUT `localhost:9200/_snapshot/backups?pretty' -d '{"type":"fs","settings":{"location":"<SAME_PATH_AS_path.repo>"},"compress":true}}'`
